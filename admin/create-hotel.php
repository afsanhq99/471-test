                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="Hotel" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="hoteltype" id="Hoteltype" placeholder=" Hotel Type eg- Family Hotel / Couple Hotel" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label">Hotel Price in
                                            USD</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="hotelprice" id="Hotelprice" placeholder=" Hotel Price is USD" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="hotelfeatures" id="Hotelfeatures" placeholder="Hotel Features Eg-free Pickup-drop facility" required>
                                        </div>
                                    </div>
